...
export class ValidationError extends AppError {
  constructor(message: string = 'ข้อมูลไม่ถูกต้อง', details?: Record<string, unknown>) {
...
export class DatabaseError extends AppError {
  constructor(message: string = 'เกิดข้อผิดพลาดในการเชื่อมต่อฐานข้อมูล', originalError?: Error) {
