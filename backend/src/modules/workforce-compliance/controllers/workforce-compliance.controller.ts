...
export const getRetirements = asyncHandler(
...
export const getPersonnelMovements = asyncHandler(
  async (_req: Request, res: Response) => {
...
export const postPersonnelMovement = asyncHandler(
...
export const putPersonnelMovement = asyncHandler(
  async (req: Request, res: Response) => {
    const movementId = Number(req.params.id);
    await WorkforceComplianceRepository.updatePersonnelMovement(
      movementId,
      req.body,
    );
    res.json({ success: true });
...
export const removePersonnelMovement = asyncHandler(
  async (req: Request, res: Response) => {
    const movementId = Number(req.params.id);
...
export const postRetirement = asyncHandler(
  async (req: Request, res: Response) => {
...
export const putRetirement = asyncHandler(
  async (req: Request, res: Response) => {
    const userId = (req as any).user?.id ?? (req as any).user?.userId;
...
export const removeRetirement = asyncHandler(
  async (req: Request, res: Response) => {
    const retirementId = Number(req.params.id);
