...
export const getLicenseSummary = asyncHandler(
...
export const postLicenseNotify = asyncHandler(
  async (req: Request, res: Response<ApiResponse>) => {
