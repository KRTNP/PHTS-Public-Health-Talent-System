...
export const refreshAccessReview = asyncHandler(
...
export const getSyncBatches = asyncHandler(
  async (req: Request, res: Response) => {
...
export const getDataIssues = asyncHandler(
  async (req: Request, res: Response) => {
    ...
    const safeIssueCode =
      typeof issue_code === "string" ? issue_code.trim() : undefined;
...
export const getSyncRecords = asyncHandler(
  async (req: Request, res: Response) => {
    const { page, limit, batch_id, target_table, search } =
...
export const getUserSyncAudits = asyncHandler(
  async (req: Request, res: Response) => {
    const { limit, batch_id, citizen_id, action } =
      req.query as unknown as UserSyncAuditsQuery;
...
export const getSyncReconciliation = asyncHandler(
  async (_req: Request, res: Response) => {
...
export const getRoleMappingDiagnostics = asyncHandler(
  async (_req: Request, res: Response) => {
...
export const getSyncSchedule = asyncHandler(
  async (_req: Request, res: Response) => {
...
export const updateSyncSchedule = asyncHandler(
  async (req: Request, res: Response) => {
