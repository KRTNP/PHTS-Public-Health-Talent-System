export const HALF_DAY_LABELS = new Set([
  "ครึ่งวัน",
  "ครึ่งวัน - เช้า",
  "ครึ่งวัน - บ่าย",
]);
...
export const LEAVE_TYPE_ALIASES: Array<{
  aliases: string[];
  normalized: string;
}> = [
  ...
  {
    aliases: ["ลากิจ", "ลากิจฉุกเฉิน", "personal", "business"],
    normalized: "personal",
  },
...
const FAMILY_CARE_PHRASE_PATTERNS = [
  "พาญาติ",
  "เฝ้าญาติ",
  "ดูแลญาติ",
  "ญาติป่วย",
...
export const ANATOMY_FALSE_RELATION_TERMS = [
  "มดลูก",
  "ปากมดลูก",
  "ลูกตา",
  "ลูกอัณฑะ",
...
const OWN_SICK_OVERRIDE_PATTERNS = [
  "ได้รับการผ่าตัด",
  "หลังการผ่าตัด",
  "หลังผ่าตัด",
  "ลาป่วยหลัง",
...
const buildPairRegex = (leftTerms: string[], rightTerms: string[]): RegExp =>
  new RegExp(
    `(${alternationFromTerms(leftTerms)}).*(${alternationFromTerms(rightTerms)})`,
  );
const buildPatternOrTermsRegex = (
  terms: string[],
  patterns: string[],
): RegExp => {
  const parts: string[] = [];
...
const buildPatternTermsPairRegex = (
  ...
  if (leftPatterns.length)
    leftParts.push(alternationFromPatterns(leftPatterns));
  return new RegExp(
    `(${leftParts.join("|")}).*(${alternationFromTerms(rightTerms)})`,
  );
};

export const SPOUSE_CHILDBIRTH_REGEX = buildPairRegex(
  WIFE_TERMS,
  CHILDBIRTH_TERMS,
);
export const SPOUSE_CHILDBIRTH_PATTERN_REGEX = buildPatternOrTermsRegex(
  [],
  SPOUSE_CHILDBIRTH_PATTERNS,
);
export const SPOUSE_CHILDCARE_REGEX = buildPairRegex(
  WIFE_TERMS,
  CHILDCARE_TERMS,
);
export const CHILDCARE_REGEX = buildTermsRegex(CHILDCARE_TERMS);
export const MALE_CHILDCARE_REGEX = buildPatternOrTermsRegex(
  [],
  MALE_CHILDCARE_PATTERNS,
);
export const PERSONAL_TASK_REGEX = buildTermsRegex(PERSONAL_TASK_TERMS);
export const FAMILY_SICK_REGEX = buildPairRegex(
  FAMILY_CONTEXT_TERMS,
  FAMILY_SICK_TERMS,
);
export const CARE_FAMILY_REGEX = buildPatternTermsPairRegex(
  [],
  CARE_ACTION_PATTERNS,
  FAMILY_CONTEXT_TERMS,
);
export const FAMILY_RELATION_REGEX = buildTermsRegex(FAMILY_CONTEXT_TERMS);
export const FAMILY_CARE_PHRASE_REGEX = buildPatternOrTermsRegex(
  [],
  FAMILY_CARE_PHRASE_PATTERNS,
);
export const OTHER_PERSON_RELATION_REGEX = buildTermsRegex(
  OTHER_PERSON_CONTEXT_TERMS,
);
export const OTHER_PERSON_MEDICAL_REGEX = buildPatternOrTermsRegex(
  [],
  OTHER_PERSON_MEDICAL_PATTERNS,
);
export const CARE_ACTION_REGEX = buildPatternOrTermsRegex(
  CARE_ACTION_TERMS,
  CARE_ACTION_PATTERNS,
);
export const HARD_SICK_REGEX = buildTermsRegex(HARD_SICK_TERMS);
export const SURGERY_REGEX = buildPatternOrTermsRegex(
  SURGERY_TERMS,
  SURGERY_PATTERNS,
);
...
export const DIRECT_SICK_REGEX = buildPatternOrTermsRegex(
  DIRECT_SICK_TERMS,
  DIRECT_SICK_PATTERNS,
);
export const LEGAL_ADMIN_CONTEXT_REGEX = buildTermsRegex(
  LEGAL_ADMIN_CONTEXT_TERMS,
);
export const OWN_SICK_OVERRIDE_REGEX = buildPatternOrTermsRegex(
  OWN_SICK_OVERRIDE_TERMS,
  OWN_SICK_OVERRIDE_PATTERNS,
);
export const WORK_MEDICAL_CONTEXT_REGEX = buildTermsRegex(
  WORK_MEDICAL_CONTEXT_TERMS,
);
export const WORK_OVERRIDE_SICK_REGEX = buildTermsRegex(
  WORK_OVERRIDE_SICK_TERMS,
);
