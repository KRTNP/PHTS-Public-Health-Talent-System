 ...
 */
export const getYearlySummary = asyncHandler(
  async (req: Request, res: Response<ApiResponse>): Promise<void> => {
 ...
 */
export const getPayoutsByPeriod = asyncHandler(
  async (req: Request, res: Response<ApiResponse>): Promise<void> => {
    ...
    ) as GetPayoutsByPeriodQuery["status"];
    const search = typeof query.search === "string" ? query.search : undefined;
    const professionCode =
      typeof query.professionCode === "string"
        ? query.professionCode
        : undefined;
    const groupNo =
      typeof query.groupNo === "string" ? query.groupNo : undefined;
...
export const markAsPaid = asyncHandler(
  async (req: Request, res: Response<ApiResponse>): Promise<void> => {
    ...
    try {
      await markPayoutAsPaid(Number.parseInt(payoutId, 10), userId, comment);
 ...
 */
export const batchMarkAsPaid = asyncHandler(
  async (req: Request, res: Response<ApiResponse>): Promise<void> => {
 ...
 */
export const cancelPayout = asyncHandler(
  async (req: Request, res: Response<ApiResponse>): Promise<void> => {
    ...
    try {
      await cancelPayoutData(Number.parseInt(payoutId, 10), userId, reason);
