...
export const listLeavePersonnel = asyncHandler(
  async (req: Request, res: Response) => {
...
export const getLeaveManagementStats = asyncHandler(
...
export const createLeaveManagement = asyncHandler(
  async (req: Request, res: Response) => {
...
export const listLeaveManagementDocuments = asyncHandler(
  async (req: Request, res: Response) => {
    const leaveManagementId = Number(req.params.leaveManagementId);
    const rows =
      await leaveManagementService.listLeaveManagementDocuments(
        leaveManagementId,
      );
    res.json({ success: true, data: rows });
  },
...
export const getLeaveManagementQuotaStatus = asyncHandler(
  async (req: Request, res: Response) => {
    const leaveManagementId = Number(req.params.leaveManagementId);
    const data =
      await leaveManagementService.getLeaveManagementQuotaStatus(
        leaveManagementId,
      );
...
export const addLeaveManagementDocuments = asyncHandler(
  async (req: Request, res: Response) => {
    try {
      const leaveManagementId = Number(req.params.leaveManagementId);
      const actorId = (req.user as any)?.userId ?? (req.user as any)?.id;
...
export const deleteLeaveManagementDocument = asyncHandler(
  async (req: Request, res: Response) => {
    const documentId = Number(req.params.documentId);
    const { deleted } =
      await leaveManagementService.deleteLeaveManagementDocument(documentId);
    res.json({ success: true, data: { deleted } });
  },
);

export const deleteLeaveManagementExtension = asyncHandler(
  async (req: Request, res: Response) => {
    const leaveManagementId = Number(req.params.leaveManagementId);
    const deleted =
      await leaveManagementService.deleteLeaveManagementExtension(
        leaveManagementId,
      );
    res.json({ success: true, data: { deleted } });
  },
...
export const listLeaveReturnReportEvents = asyncHandler(
  async (req: Request, res: Response) => {
    const leaveManagementId = Number(req.params.leaveManagementId);
    const rows =
      await leaveManagementService.listLeaveReturnReportEvents(
        leaveManagementId,
      );
    res.json({ success: true, data: rows });
  },
