...
// Master Rates
export const getMasterRates = asyncHandler(
...
export const updateMasterRate = asyncHandler(
  async (req: Request, res: Response) => {
    ...
    const merged = {
      profession_code: String(
        body.profession_code ?? existingRate.profession_code ?? "",
      ),
      ...
      condition_desc: String(
        body.condition_desc ?? existingRate.condition_desc ?? "",
      ),
      detailed_desc: String(
        body.detailed_desc ?? existingRate.detailed_desc ?? "",
      ),
      is_active:
...
export const createMasterRate = asyncHandler(
  async (req: Request, res: Response) => {
    const {
      profession_code,
      group_no,
...
export const getRatesByProfession = asyncHandler(
  async (req: Request, res: Response) => {
...
export const getRateHierarchy = asyncHandler(
  async (req: Request, res: Response) => {
    if (!req.user) throw new AuthenticationError("Unauthorized access");
