 ...
 */
export const getPeriodWithSnapshot = asyncHandler(
 ...
 */
export const freezePeriod = asyncHandler(
  async (req: Request, res: Response<ApiResponse>): Promise<void> => {
    const periodId = Number.parseInt(req.params.id, 10);
    const user = req.user;
    if (!user) {
 ...
 */
export const unfreezePeriod = asyncHandler(
  async (req: Request, res: Response<ApiResponse>): Promise<void> => {
    const periodId = Number.parseInt(req.params.id, 10);
    const user = req.user;
    if (!user) {
 ...
 */
export const getSnapshotsForPeriod = asyncHandler(
  async (req: Request, res: Response<ApiResponse>): Promise<void> => {
    const periodId = Number.parseInt(req.params.id, 10);
 ...
 */
export const getReportData = asyncHandler(
  async (req: Request, res: Response<ApiResponse>): Promise<void> => {
    const periodId = Number.parseInt(req.params.id, 10);
    try {
 ...
 */
export const getSummaryData = asyncHandler(
  async (req: Request, res: Response<ApiResponse>): Promise<void> => {
    const periodId = Number.parseInt(req.params.id, 10);
    try {
 ...
 */
export const getSnapshotReadiness = asyncHandler(
  async (req: Request, res: Response<ApiResponse>): Promise<void> => {
    const periodId = Number.parseInt(req.params.id, 10);
    const period = await snapshotService.getPeriodWithSnapshot(periodId);
    if (!period) {
